...
| 文档                                                                                                  | 用途           | 目标读者       | 何时使用                | 重要性   |
|-----------------------------------------------------------------------------------------------------|--------------|------------|---------------------|-------|
| **[代码编写规范.md](代码编写规范.md)**                                                                          | **编码标准详细参考** | **开发者、AI** | **⭐ 写代码前必读，必须严格遵守** | ⭐⭐⭐⭐⭐ |
...
2. **阅读**: [代码编写规范.md](代码编写规范.md) - 了解编码规范
...
2. **阅读**: [代码编写规范.md](代码编写规范.md) - 确认修复方案符合规范
3. **遵循**: [代码AI生成工作流.md](代码AI生成工作流.md) - 完成4步验证
4. **验证**: 运行启动测试确保无副作用

#### 代码重构

1. **阅读**: [代码编写规范.md#8-代码设计原则](代码编写规范.md#8-代码设计原则) - 确保符合设计原则
2. **阅读**: [代码编写规范.md#84-接口实现分离模式](代码编写规范.md#84-接口实现分离模式三层架构) - 三层架构模式
...
- [代码编写规范.md - Bean管理](代码编写规范.md#26-springboot-bean管理规范)
...
- [ ] **单元测试通过**: `mvn test`所有测试用例通过
- [ ] **启动测试通过**: `mvn test -Dtest=ApplicationStartupTests -pl start`成功
- [ ] **测试覆盖率**: Domain层测试覆盖率>80%

### ✅ 架构规范检查

- [ ] **分层正确**: 依赖方向符合DDD（Adapter → App → Domain ← Infrastructure）
- [ ] **接口分离**: 通用服务有接口，实现在Infrastructure层
- [ ] **枚举标准**: 无魔法值，全部使用枚举
- [ ] **异常处理**: 使用统一异常体系

### ✅ 代码质量检查

- [ ] **日志规范**: 使用@Slf4j，日志级别正确
- [ ] **注释完整**: public方法有Javadoc注释
- [ ] **命名规范**: 遵循Java约定
- [ ] **Lombok规范**: 精确使用注解，不使用@Data

### ✅ 安全与性能检查

- [ ] **禁止事项**: 不违反[代码编写规范.md#9-禁止事项](代码编写规范.md#9-禁止事项)
...
**详细说明**: [代码编写规范.md - 接口实现分离](代码编写规范.md#84-接口实现分离模式三层架构)
...
- **移除内容**: 所有详细编码规范迁移到[代码编写规范.md](代码编写规范.md)
