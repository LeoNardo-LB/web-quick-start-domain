...
import org.smm.archetype.infrastructure.bizshared.dal.generated.entity.EventDO;
...
public class EventRepository {
    ...
    public List<EventConsumeRecord> findRetryConsumeEvents(int limit) {
        ...
        return eventDOs.stream().map(this::toConsumeRecord).toList();
    }
     ...
     * @return 事件消费记录
     */
    private EventConsumeRecord toConsumeRecord(EventDO eventDO) {
