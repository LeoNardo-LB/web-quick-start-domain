 ...
 */
@Getter
public class DomainEventsCollectionEvent extends ApplicationEvent {

    private final List<AggregateRoot> aggregates;

    private final List<DomainEvent> domainEvents;

    public DomainEventsCollectionEvent(List<AggregateRoot> aggregates, List<DomainEvent> domainEvents) {
        super(aggregates);
