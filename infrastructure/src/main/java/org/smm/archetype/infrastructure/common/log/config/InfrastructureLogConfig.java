package org.smm.archetype.infrastructure.common.log.config;
...
public class InfrastructureLogConfig {
     ...
     */
    @Bean
    public FilePersistenceHandler filePersistenceHandler(
            final List<StringifyHandler> stringifyHandlers,
            final JdkStringifyHandler jdkStringifyHandler) {
     ...
     */
    @Bean
    public LogDataAccessor logDataAccessor(
    ...
    public LogAspect logAspect(
            final List<PersistenceHandler> persistenceHandlers,
            final List<StringifyHandler> stringifyHandlers) {
