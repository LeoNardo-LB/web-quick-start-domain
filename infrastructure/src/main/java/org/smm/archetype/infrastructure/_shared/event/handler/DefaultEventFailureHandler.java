...
public class DefaultEventFailureHandler implements EventFailureHandler {
    ...
    @Override
    public void handleFailure(DomainEvent event, EventConsumeDO consumeDO, Exception e) {
        log.error("""
                ...
                consumeDO.getErrorMessage(),
                consumeDO.getRetryTimes(),
                consumeDO.getConsumerGroup(),
                consumeDO.getConsumerName(),
                consumeDO.getCreateTime(),
                e
        );
